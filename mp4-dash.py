...
NOPAD_SEGMENT_PATTERN       = '%llu.m4s'
NOPAD_SEGMENT_URL_PATTERN   = '%d.m4s'
NOPAD_SEGMENT_URL_TEMPLATE  = '$RepresentationID$/$Number$.m4s'
        ...
        for adaptation_set_name, tracks in adaptation_sets.items():
            for track in tracks:
                if options.split:
                    ...
                    #@@
                    track.representation_id = track.representation_id.replace('/','-')
                    print('track.representation_id={}'.format(track.representation_id))
            ...
            for adaptation_sets in [audio_sets, video_sets, subtitles_sets]:
                for adaptation_set_name, tracks in adaptation_sets.items():
                    ...
                    for track in tracks:
                        ...
                        #     MakeNewDir(out_dir)
                        out_dir = path.join(out_dir, str(track.representation_id))
                        MakeNewDir(out_dir)
